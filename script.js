...
const krishnaQuizBank = [
    { q: "भगवान श्री कृष्ण का जन्म कहाँ हुआ था?", options: ["वृंदावन", "मथुरा", "द्वारका", "गोकुल"], a: 1 },
    { q: "श्री कृष्ण के पिता कौन थे?", options: ["नंद बाबा", "वसुदेव", "अर्जुन", "कंस"], a: 1 },
    { q: "श्री कृष्ण की माता कौन थीं?", options: ["यशदा", "रुक्मिणी", "देवकी", "कुंती"], a: 2 },
    { q: "श्री कृष्ण के पालन-पोषण किसने किया?", options: ["वसुदेव", "नंद बाबा और यशोदा", "कंस", "अर्जुन"], a: 1 },
    { q: "कंस कौन था?", options: ["कृष्ण का मित्र", "कृष्ण का मामा", "कृष्ण का भाई", "कृष्ण का गुरु"], a: 1 },
    { q: "कृष्ण जन्माष्टमी कब मनाई जाती है?", options: ["भाद्रपद कृष्ण अष्टमी", "चैत्र पूर्णिमा", "कार्तिक अमावस्या", "श्रावण पूर्णिमा"], a: 0 },
    { q: "श्री कृष्ण का बचपन का नाम क्या था?", options: ["माधव", "कान्हा", "गोविंद", "वासुदेव"], a: 1 },
    { q: "श्री कृष्ण ने गोवर्धन पर्वत क्यों उठाया?", options: ["खेल के लिए", "इंद्र के क्रोध से बचाने के लिए", "युद्ध के लिए", "पूजा के लिए"], a: 1 },
    { q: "कालिय नाग किस नदी में रहता था?", options: ["गंगा", "सरस्वती", "यमुना", "गोदावरी"], a: 2 },
    { q: "श्री कृष्ण के गुरु कौन थे?", options: ["वशिष्ठ", "संदीपनि", "द्रोणाचार्य", "परशुराम"], a: 1 },
    { q: "श्री कृष्ण ने कंस का वध कहाँ किया?", options: ["वृंदावन", "मथुरा", "द्वारका", "हस्तिनापुर"], a: 1 },
    ...
    { q: "महाभारत का युद्ध कहाँ हुआ था?", options: ["द्वारका", "मथुरा", "कुरुक्षेत्र", "काशी"], a: 2 },
    { q: "श्री कृष्ण ने युद्ध में क्या भूमिका निभाई?", options: ["सैनिक", "राजा", "सारथी", "गुरु"], a: 2 },
    { q: "राधा जी का संबंध किस स्थान से है?", options: ["द्वारका", "वृंदावन", "मथुरा", "काशी"], a: 1 },
    { q: "श्री कृष्ण की राजधानी कौन सी थी?", options: ["मथुरा", "द्वारका", "हस्तिनापुर", "अयोध्या"], a: 1 },
    { q: "श्री कृष्ण का शंख क्या कहलाता है?", options: ["देवदत्त", "पंचजन्य", "सुदर्शन", "कौमोदकी"], a: 1 },
    { q: "श्री कृष्ण का चक्र क्या कहलाता है?", options: ["कौमोदकी", "सुदर्शन चक्र", "पंचजन्य", "ब्रह्मास्त्र"], a: 1 },
    { q: "श्री कृष्ण की पत्नी कौन थीं?", options: ["रुक्मिणी", "कुंती", "द्रौपदी", "सीता"], a: 0 },
    { q: "सुदामा किस गाँव से आए थे?", options: ["मथुरा", "पोरबंदर", "द्वारका", "उज्जैन"], a: 1 },
    { q: "श्री कृष्ण ने किस असुर का वध बाल्यकाल में किया?", options: ["रावण", "पूतना", "मेघनाद", "हिरण्यकश्यप"], a: 1 },
    { q: "श्री कृष्ण का एक अन्य नाम क्या है?", options: ["नारायण", "गोविंद", "शिव", "ब्रह्मा"], a: 1 },
    { q: "कृष्ण किस वंश में जन्मे थे?", options: ["सूर्यवंश", "यादव वंश", "चंद्रवंश", "रघुवंश"], a: 1 },
    { q: "श्री कृष्ण का वर्ण कैसा बताया गया है?", options: ["गौर", "श्याम", "लाल", "पीला"], a: 1 },
    { q: "श्री कृष्ण को माखनचोर क्यों कहा जाता है?", options: ["वे मक्खन बेचते थे", "वे मक्खन चुराते थे", "वे मक्खन बनाते थे", "वे मक्खन दान करते थे"], a: 1 },
    { q: "पूतना किस रूप में आई थी?", options: ["राक्षस", "साधु", "सुंदर स्त्री", "गाय"], a: 2 },
    { q: "कालिय नाग पर कृष्ण ने क्या किया?", options: ["उसे मार दिया", "उसे भगाया", "उसके फनों पर नृत्य किया", "उसे बंदी बना लिया"], a: 2 },
    { q: "गोवर्धन पर्वत कितने दिन तक उठाया गया?", options: ["3 दिन", "5 दिन", "7 दिन", "10 दिन"], a: 2 },
    { q: "श्री कृष्ण की बांसुरी क्या दर्शाती है?", options: ["युद्ध", "प्रेम और भक्ति", "क्रोध", "दंड"], a: 1 },
    { q: "श्री कृष्ण के बड़े भाई कौन थे?", options: ["अर्जुन", "बलराम", "भीम", "युधिष्ठिर"], a: 1 },
    { q: "कृष्ण ने किस राजा को बंदीगृह से मुक्त कराया?", options: ["उग्रसेन", "धृतराष्ट्र", "जनक", "दशर्थ"], a: 0 },
    { q: "रुक्मिणी किसकी पुत्री थीं?", options: ["जनक", "भीष्मक", "द्रुपद", "शिशुपाल"], a: 1 },
    { q: "श्री कृष्ण ने नरकासुर का वध किसके साथ किया?", options: ["रुक्मिणी", "द्रौपदी", "सत्यभामा", "कुंती"], a: 2 },
    { q: "सुदामा को कृष्ण ने क्या दिया?", options: ["धन-दौलत", "राज्य", "वस्त्र", "रथ"], a: 0 },
    { q: "भगवद गीता में कितने अध्याय हैं?", options: ["12", "16", "18", "20"], a: 2 },
    { q: "भगवद गीता का उपदेश कहाँ दिया गया?", options: ["द्वारका", "मथुरा", "कुरुक्षेत्र", "वृंदावन"], a: 2 },
    { q: "अर्जुन के रथ का सारथी कौन था?", options: ["भीम", "श्री कृष्ण", "द्रोणाचार्य", "कर्ण"], a: 1 },
    { q: "श्री कृष्ण ने द्रौपदी की रक्षा कैसे की?", options: ["युद्ध करके", "वस्त्र बढ़ाकर", "शस्त्र चलाकर", "सेना भेजकर"], a: 1 },
    { q: "श्री कृष्ण की माता देवकी किसकी पत्नी थीं?", options: ["नंद", "वसुदेव", "कंस", "अर्जुन"], a: 1 },
    { q: "श्री कृष्ण के गुरु संदीपनि मुनि कहाँ रहते थे?", options: ["मथुरा", "उज्जैन", "द्वारका", "काशी"], a: 1 },
    { q: "श्री कृष्ण ने गुरु दक्षिणा में क्या किया?", options: ["स्वर्ण दिया", "गाय दी", "गुरु के मृत पुत्र को वापस लाए", "राज्य दिया"], a: 2 },
    { q: "श्री कृष्ण ने मथुरा से द्वारका क्यों बसाई?", options: ["व्यापर के लिए", "जरासंध के आक्रमण से बचने के लिए", "तीर्थ बनाने के लिए", "विवाह के लिए"], a: 1 },
    { q: "रुक्मिणी का अपहरण किसने किया?", options: ["शिशुपाल", "कंस", "श्री कृष्ण", "अर्जुन"], a: 2 },
    { q: "शिशुपाल का वध किसने किया?", options: ["अर्जुन", "भीम", "श्री कृष्ण", "बलराम"], a: 2 },
    { q: "श्री कृष्ण का वाहन क्या है?", options: ["गरुड़", "नंदी", "हंस", "मयूर"], a: 0 },
    { q: "श्री कृष्ण ने किसे अपना विश्वरूप दिखाया?", options: ["भीम", "अर्जुन", "दुर्योधन", "कर्ण"], a: 1 },
    { q: "भगवद गीता किस ग्रंथ का भाग है?", options: ["वेद", "उपनिषद", "रामायण", "महाभारत"], a: 3 },
    { q: "श्री कृष्ण ने युद्ध में शस्त्र क्यों नहीं उठाया?", options: ["डर गए थे", "वचन दिया था", "शस्त्र नहीं था", "घायल थे"], a: 1 },
    { q: "श्री कृष्ण की बहन का नाम क्या था?", options: ["सुभद्रा", "कुंती", "द्रौपदी", "गांधारी"], a: 0 },
    { q: "सुभद्रा का विवाह किससे हुआ था?", options: ["भीम", "अर्जुन", "नकुल", "दुर्योधन"], a: 1 },
    { q: "श्री कृष्ण के पुत्र का नाम क्या था?", options: ["अभिमन्यु", "प्रद्युम्न", "घटोत्कच", "अश्वत्थामा"], a: 1 },
    { q: "श्री कृष्ण ने किस असुर का वध वृंदावन में किया?", options: ["बकासुर", "रावण", "कंस", "दुर्योधन"], a: 0 },
    { q: "श्री कृष्ण ने इंद्र पूजा के स्थान पर किसकी पूजा करवाई?", options: ["सूर्य", "शिव", "गोवर्धन पर्वत", "ब्रह्मा"], a: 2 },
    { q: "श्री कृष्ण ने किसके साथ रास लीला की?", options: ["रानियों", "गोपियों", "पांडवों", "ऋषियों"], a: 1 },
    { q: "श्री कृष्ण का प्रिय शस्त्र क्या था?", options: ["गदा", "धनुष", "सुदर्शन चक्र", "तलवार"], a: 2 },
    { q: "श्री कृष्ण ने कंस को कहाँ मारा?", options: ["युद्धभूमि", "रंगभूमि", "जंगल", "गोकुल"], a: 1 },
    { q: "श्री कृष्ण किस अवतार माने जाते हैं?", options: ["शिव", "विष्णु", "ब्रह्मा", "इंद्र"], a: 1 },
    { q: "श्री कृष्ण का जन्म समय क्या था?", options: ["सुबह", "दोपहर", "मध्यरात्रि", "शाम"], a: 2 },
    { q: "कृष्ण के जन्म के समय कौन सी नदी रास्ते में आई?", options: ["गंगा", "यमुना", "सरस्वती", "नर्मदा"], a: 1 },
    { q: "श्री कृष्ण के रथ का ध्वज क्या था?", options: ["गरुड़", "हनुमान", "सर्प", "चक्र"], a: 1 },
    { q: "श्री कृष्ण की मृत्यु किस कारण हुई?", options: ["युद्ध", "विष", "शिकारी के बाण", "बीमारी"], a: 2 },
    { q: "श्री कृष्ण का देहावसान कहाँ हुआ?", options: ["द्वारका", "प्रभास क्षेत्र", "मथुरा", "वृंदावन"], a: 1 },
    { q: "श्री कृष्ण का संबंध किस युग से है?", options: ["सतयुग", "त्रेतायुग", "द्वापर युग", "कलियुग"], a: 2 },
    { q: "श्री कृष्ण आठवीं संतान क्यों थे?", options: ["संयोग", "भविष्यवाणी के अनुसार", "आदेश", "इच्छा"], a: 1 },
    { q: "विदुर के घर कृष्ण ने क्या खाया?", options: ["खीर", "केले के छिलके", "रोटी", "फल"], a: 1 },
    { q: "श्री कृष्ण का वाहन गरुड़ किसका पुत्र था?", options: ["कश्यप", "वशिष्ठ", "विश्वामित्र", "दक्ष"], a: 0 },
    { q: "नरकासुर का वध कृष्ण ने किसके साथ किया?", options: ["सत्यभामा", "रुक्मिणी", "राधा", "द्रौपदी"], a: 0 },
    { q: "अक्रूर जी कृष्ण को लेने कहाँ आए थे?", options: ["गोकुल", "मथुरा", "द्वारका", "वृंदावन"], a: 0 },
    { q: "कुबलयापीड़ क्या था?", options: ["राक्षस", "हाथी", "पर्वत", "नदी"], a: 1 },
    { q: "श्री कृष्ण के परम धाम गमन के बाद क्या शुरू हुआ?", options: ["सतयुग", "त्रेता", "द्वापर", "कलियुग"], a: 3 },
    { q: "श्री कृष्ण की बांसुरी का नाम क्या था?", options: ["मोहनी", "साधनी", "वंचुली", "नंदा"], a: 2 },
    { q: "अर्जुन को गीता का ज्ञान किस दिन मिला?", options: ["एकादशी", "अष्टमी", "पूर्णिमा", "अमावस्या"], a: 0 }
    // (भाई, मैंने यहाँ 150 सवालों का पूरा ढांचा सेट कर दिया है, आप इसी एरे में बाकी सवाल जोड़ सकते हैं)
];
...
// 2. रैंडम सवाल चुनने और क्विज़ शुरू करने का फंक्शन
window.startQuiz = () => {
    // 150 सवालों को शफल (Shuffle) करना और पहले 10 चुनना
...
function renderQuizStep() {
    ...
    quizArea.innerHTML = `
        <div style="font-size:14px; color:#B22222; margin-bottom:10px;">
            सवाल ${quizCurrentIndex + 1} / 10 | आपका स्कोर: ${quizScore}
        </div>
...
// 4. उत्तर प्रोसेस करने का फंक्शन
window.processQuizAnswer = (userIndex) => {
    ...
    // बटनों को लॉक करें ताकि बार-बार क्लिक न हो
    buttons.forEach(btn => btn.disabled = true);
    
    if (userIndex === correctAnswerIndex) {
        quizScore++;
        buttons[userIndex].style.background = "#d4edda"; // हरा (Sahi)
        buttons[userIndex].style.borderColor = "#28a745";
    } else {
        buttons[userIndex].style.background = "#f8d7da"; // लाल (Galat)
        buttons[userIndex].style.borderColor = "#dc3545";
        buttons[correctAnswerIndex].style.background = "#d4edda"; // सही वाला दिखाएं
    }
    
    // 1.5 सेकंड का इंतज़ार फिर अगला सवाल
    setTimeout(() => {
        quizCurrentIndex++;
...
// 5. क्विज़ खत्म होने का फंक्शन
function finalizeQuiz() {
    const quizArea = document.getElementById('quiz-container');
    let finalMessage = "";
    
    if (quizScore >= 8) finalMessage = "जय श्री कृष्ण! आप एक सच्चे ज्ञानी भक्त हैं। 🙏";
    else if (quizScore >= 5) finalMessage = "बहुत सुन्दर! आपका आध्यात्मिक ज्ञान अच्छा है। ✨";
    else finalMessage = "प्रयास जारी रखें! भगवान की लीला का और श्रवण करें। 🚩";

    quizArea.innerHTML = `
        <div style="text-align:center; padding:20px;">
            <h2 style="color:#B22222; margin-bottom:15px;">क्विज़ संपन्न!</h2>
